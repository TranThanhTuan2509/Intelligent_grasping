...
# Set MOLMO_LOAD_4BIT=1 to run on GPUs with <16GB VRAM (e.g. RTX 3060 12GB)
USE_4BIT = os.environ.get("MOLMO_LOAD_4BIT", "0") == "1"

# Directory to store downloaded model weights (inside the project, not HF cache)
...
if USE_4BIT:
    print("[Molmo] Loading with 4-bit quantization (12GB GPU mode)...")

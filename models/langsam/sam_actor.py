...
class SAMActor:
    def __init__(self, use_gpu=False):
        ...
        _weights_dir = os.path.abspath(_weights_dir)
        os.makedirs(_weights_dir, exist_ok=True)
        self.model = SamModel.from_pretrained("facebook/sam-vit-huge", cache_dir=_weights_dir).to(self.device)
        self.processor = SamProcessor.from_pretrained("facebook/sam-vit-huge", cache_dir=_weights_dir)
